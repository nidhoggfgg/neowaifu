...
import { CubismFramework, Option } from '../lapp/framework/live2dcubismframework';
...
export class LAppDelegate {
  ...
  public initialize(): boolean {
    ...
    if (!gl) {
      ...
      LAppPal.printMessage('This browser does not support the <code>&lt;canvas&gt;</code> element.');
