...
import { CubismDefaultParameterId } from '../lapp/framework/cubismdefaultparameterid';
import { CubismModelSettingJson } from '../lapp/framework/cubismmodelsettingjson';
import {
  BreathParameterData,
  CubismBreath
} from '../lapp/framework/effect/cubismbreath';
import { CubismEyeBlink } from '../lapp/framework/effect/cubismeyeblink';
import { ICubismModelSetting } from '../lapp/framework/icubismmodelsetting';
import { CubismIdHandle } from '../lapp/framework/id/cubismid';
import { CubismFramework } from '../lapp/framework/live2dcubismframework';
import { CubismMatrix44 } from '../lapp/framework/math/cubismmatrix44';
import { CubismUserModel } from '../lapp/framework/model/cubismusermodel';
import {
  ACubismMotion,
  FinishedMotionCallback
} from '../lapp/framework/motion/acubismmotion';
import { CubismMotion } from '../lapp/framework/motion/cubismmotion';
import {
  CubismMotionQueueEntryHandle,
  InvalidMotionQueueEntryHandleValue
} from '../lapp/framework/motion/cubismmotionqueuemanager';
import { csmMap } from '../lapp/framework/type/csmmap';
import { csmRect } from '../lapp/framework/type/csmrectf';
import { csmString } from '../lapp/framework/type/csmstring';
import { csmVector } from '../lapp/framework/type/csmvector';
import {
  CSM_ASSERT,
  CubismLogError,
  CubismLogInfo
} from '../lapp/framework/utils/cubismdebug';
...
import { CubismMoc } from '../lapp/framework/model/cubismmoc';
...
export class LAppModel extends CubismUserModel {
  ...
  public loadAssets(dir: string, fileName: string): void {
    ...
    fetchOrCache(`${this._modelHomeDir}${fileName}`)
      .then(arrayBuffer => {
